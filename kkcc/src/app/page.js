    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#F1EFE7] text-black">
      ...
      <header className="px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex gap-4">
          <Link href="/login">
            <button className="text-black px-4 py-2 rounded border border-black hover:bg-black hover:text-white">
              Login
            </button>
          </Link>
          <Link href="/signup1">
            <button className="bg-[#FF637A] text-white px-4 py-2 rounded font-semibold hover:bg-pink-500">
              Sign Up
            </button>
          </Link>
        </nav>
      ...
      <main className="flex flex-col items-center justify-center flex-grow text-center px-4 py-10 gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center bg-white px-6 py-4 rounded shadow mt-4">
          ...
          <Link href="/signup1">
            <button className="bg-[#FF637A] text-white px-6 py-2 rounded hover:bg-pink-500 font-semibold">
              Start Learning
            </button>
          </Link>
        </div>
